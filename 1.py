...
person2 = Person(name="A", age=19)

print(person2.greet()) # 輸出: Hello, my name is A and I am 19 years old.

person2.haveBirthday() # 輸出: Happy birthday, A! You are now 19 years old.
